...
;                                                                                                                                     
Run;                                                   
Proc tabulate data = test F=6.0; /*F=6.0 means the entire varibale are using 6.0 as the format*/
...
table region*(division all='Subtotal') /*this all is for division*/
         all='Total for All Regions'*f=dollar12.,
 /*the above all is for region*/
         type='Customer Base'*expenditures=' '*sum=' '
         all='All Customers'*expenditures=' '*sum=' ' /*taking about kast customer*/
 
      / rts=25; /*rts showing how big is the table*/
